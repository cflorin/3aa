...
- Table columns (V1): `Ticker`, `Company`, `Sector`, `3AA Code` (badge), `Confidence`, `Zone` (placeholder `—` until EPIC-005), `Market Cap`, `Monitoring` (Active/Inactive badge), `Rev Growth Fwd`, `EPS Growth Fwd`, `FCF Conv`, `Net Debt/EBITDA`, `Operating Margin`
- **Row click:** clicking any table row navigates to `/stocks/[ticker]` (Stock Detail Page, STORY-053)
- **Metric color-coding (prototype thresholds):**
  - Growth fields (`Rev Growth Fwd`, `EPS Growth Fwd`, `Rev Growth 3Y`, `EPS Growth 3Y`): green ≥ 8%, yellow ≥ 3%, red < 3%
  - `Net Debt/EBITDA`: green ≤ 1×, yellow ≤ 2.5×, red > 2.5×
  - `FCF Conv`: green ≥ 80%, yellow ≥ 50%, red < 50%
...
- Stock detail page content (STORY-053 — this story only adds the row click navigation to it)
...
- [ ] Table columns present: Ticker, Company, Sector, 3AA Code, Confidence, Zone, Market Cap, Monitoring, Rev Growth Fwd, EPS Growth Fwd, FCF Conv, Net Debt/EBITDA, Operating Margin
- [ ] Zone column shows `—` placeholder for all rows (EPIC-005 will populate it)
- [ ] Row click navigates to `/stocks/[ticker]` (full-page navigation, not modal)
- [ ] Metric color-coding applied: growth fields (green ≥ 8%, yellow ≥ 3%, red < 3%), Net Debt/EBITDA (green ≤ 1×, yellow ≤ 2.5×, red > 2.5×), FCF Conv (green ≥ 80%, yellow ≥ 50%, red < 50%)
